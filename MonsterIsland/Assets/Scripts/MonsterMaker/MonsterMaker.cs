...
public class MonsterMaker : MonoBehaviour {
    ...
    public void Start()
    {
        ...
        {
            collectedHeads = new string[] { "Mitch", "Lion" },
            collectedTorsos = new string[] { "Mitch", "Lion"},
            collectedRightArms = new string[] { "Mitch", "Turtle" },
            collectedLeftArms = new string[] { "Mitch", "Turtle" },
